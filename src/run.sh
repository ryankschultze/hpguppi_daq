...
iptables -t raw -A PREROUTING -i ens6d1 -p udp -j DROP

# Set interrupt coalescing
ethtool -C ens6d1 adaptive-rx on
ethtool -C ens6d1 rx-frames 8
ethtool -C ens6d1 rx-usecs 0

# Set ring sizes to max
ethtool -G ens6d1 rx 8192
...
numactl --cpunodebind=1 --membind=1 \
  $perf \
${PREFIX_EXEC}hashpipe -p ${PREFIX_LIB}hpguppi_daq.so -I 0 \
-o BINDHOST=ens6d1 \
-o BINDPORT=10000 \
