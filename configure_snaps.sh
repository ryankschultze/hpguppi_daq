...
cfg="/homelocal/sonata/mydonsol/hpguppi_daq/ataconfig-port10000.yml"
...
echo /homelocal/sonata/mydonsol/hpguppi_daq/populate_meta.py ${cfg} -s ${snaps} -I -i 0
/homelocal/sonata/mydonsol/hpguppi_daq/populate_meta.py ${cfg} -s ${snaps} -I -i 0
